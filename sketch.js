...
function drawPockets() {
  let borderWidth = 20; // Assuming the border width of the table
  let pocketRadius = Math.min(windowWidth, windowHeight) * RELATIVE_POCKET_RADIUS; // Assuming the radius for pockets, adjust as needed
...
function checkFoulConsequences() {
  ...
  const foulLimit = 5; // Define your foul limit
...
function showRules() {
  // Set showRulesScreen to true to render the rules overlay
